/**
* @overview Typing indicators show that the user is typing with visual cues such as blinking dots or an explicit notification such as “typing…”. The ChatEngine Typing Indicator plugin emits events when a user starts and stops typing. <br> <img src="plugins/chat-engine-typing-indicator/output.gif" height="300"></img> <br>
